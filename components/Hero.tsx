...
const Hero: React.FC = () => {
  return (
    <section id="hero" className="relative overflow-hidden bg-[#0b1220] text-white pt-16 pb-20 hero-aurora">
      ...
      <div className="relative max-w-5xl mx-auto px-4 space-y-8 animate-in fade-in slide-in-from-left duration-700">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl lg:text-5xl font-black leading-[1.08]">
