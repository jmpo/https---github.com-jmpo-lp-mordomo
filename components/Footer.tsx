        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/18 border border-white/20 text-white font-black text-sm px-4 py-2.5 rounded-xl transition-all active:scale-95"
            >
              <span className="material-symbols-outlined text-primary text-base">play_circle</span>
              Ver demo
            </a>
            <a
              href="https://wa.link/wcvh0b"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-black text-sm px-4 py-2.5 rounded-xl transition-all active:scale-95 shadow-lg shadow-[#25D366]/25"
            >
